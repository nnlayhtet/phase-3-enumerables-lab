...
def print_spicy_foods(spicy_foods)
  # your code here
  spicy_foods.each {|spicy_food| puts spicy_food[:name] + " (#{spicy_food[:cuisine]}) | Heat Level: " + '🌶' * spicy_food[:heat_level]}
end
...
def print_spiciest_foods(spicy_foods)
  # your code here
  print_spicy_foods(spicy_foods.filter {|f| f[:heat_level]>5})
end
...
def average_heat_level(spicy_foods)
  ...
  total_heat_level = spicy_foods.sum {|f| f[:heat_level]}
